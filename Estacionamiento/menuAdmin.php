...
if (isset($_SESSION["administrador"])) {
    ...
    <header>
  		...
  		<nav>
            <ul>
                <li><a href="menuAdmin.php" style="color:#fff;background:#e6344a;text-decoration:none;"><span class="glyphicon glyphicon-home"></span>Inicio</a></li>
                <li class="submenu">
            ...
            <nav>
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul class="children">
                            <li><a href="listadoAutos.php" style="color:#fff;">Registros de Autos<span class="glyphicon glyphicon-record"></span></a></li>
